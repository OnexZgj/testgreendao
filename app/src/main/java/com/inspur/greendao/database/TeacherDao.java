...
*/
public class TeacherDao extends AbstractDao<Teacher, Void> {
    ...
    @Override
    protected final Void updateKeyAfterInsert(Teacher entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(Teacher entity) {
        return null;
    }
